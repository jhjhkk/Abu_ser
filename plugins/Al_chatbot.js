...
if (conf.LANG == 'ML') {
    ...
    succ_off = 'Abu സെമി-ഫങ്ഷണൽ ആയി സജ്ജമാക്കുക! കുറച്ച് കാത്തിരിക്കൂ! ☑️'
}

New.addCommand({ pattern: 'Abu ?(.*)', desc: _dsc, fromMe: true,dontAddCommandList: true, usage: '.Abu on / off' }, (async (message, match) => {
